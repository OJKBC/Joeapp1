...
const CONFIG = {
  ...
  showPromptPic: false,  // 問題の絵文字ヒントを出すか（false=絵を出さず、音だけで当てる）
  rate: 0.78,            // 読み上げ速度（小さいほどゆっくり。1.0がふつう）
  pitch: 1.05,           // 読み上げの高さ（1.0がふつう。少し高めで子ども向けに明るく）
  sound: true            // 効果音（ビーム音・着弾音）のオン/オフ
};

/* =========================================================
   しゅーてぃんぐ（🚀 ミニゲーム）の せってい
   ・ことばは LEVELS と おなじものを つかう
   ========================================================= */
const SHOOT = {
  hearts: 5,        // ライフ
  baseFall: 13,     // れべる1は 何びょうかけて 落ちてくるか（大きいほど ゆっくり）
  minFall: 6,       // いちばん はやいときの 落下びょうすう
  levelStep: 0.9    // れべるが 1あがるごとに 何びょう はやくなるか
};

/* =========================================================
   もじを とりもどせ！（🔤 ミニゲーム）の せってい
   ようかいが かくした もじを タイルから えらんで とりもどす。
   ========================================================= */
const MOJI = {
  hearts: 5,   // ライフ
  tiles: 8,    // したに ならぶ もじタイルの かず
  maxLen: 5    // これより ながい ことばは 出さない（1れつに おさまらないため）
};
/* にている もじ（まちがいタイルに まぜて「よくみて！」させる） */
const SIMILAR_KANA = {
  'い':'りこ', 'り':'いん', 'ぬ':'めね', 'め':'ぬあ', 'わ':'ねれ', 'ね':'われ', 'れ':'わね',
  'さ':'ちき', 'き':'さま', 'ち':'さら', 'ら':'ちう', 'は':'ほけ', 'ほ':'はま', 'ま':'もほ',
  'も':'まし', 'る':'ろそ', 'ろ':'るそ', 'く':'へし', 'へ':'くつ', 'し':'つも', 'つ':'しう',
  'た':'なに', 'な':'たに', 'に':'なこ', 'こ':'にい', 'う':'つら', 'お':'あす', 'あ':'おめ',
  'ん':'そり', 'そ':'ろん', 'け':'はに', 'ふ':'うら', 'や':'せか', 'よ':'まも', 'ゆ':'めお',
  'が':'かぎ', 'ば':'ぱは', 'ぱ':'ばは', 'び':'ぴひ', 'ぴ':'びひ', 'ぶ':'ぷふ', 'ぷ':'ぶふ',
  'べ':'ぺへ', 'ぺ':'べへ', 'ぼ':'ぽほ', 'ぽ':'ぼほ', 'っ':'つし', 'ー':'いり',
  'ゃ':'やゆ', 'ゅ':'ゆよ', 'ょ':'よや'
};
...
const LEVELS = [
  { name: '2もじ ①', hp: 6, items: [
    ...
    {t:'いえ',p:'🏠'},{t:'かさ',p:'☂️'},{t:'くつ',p:'👟'},{t:'ふね',p:'⛵'},{t:'やま',p:'⛰️'},{t:'はな',p:'🌸'},
    {t:'いぬ',p:'🐶'},{t:'うま',p:'🐎'},{t:'さる',p:'🐵'},{t:'みみ',p:'👂'},{t:'ほし',p:'⭐'},{t:'すし',p:'🍣'},
    {t:'たこ',p:'🐙'},{t:'かに',p:'🦀'},{t:'あめ',p:'🌧️'}
  ]},
  { name: '2もじ ②', hp: 6, items: [
    {t:'はれ',p:'☀️'},{t:'ゆめ',p:'💭'},{t:'つき',p:'🌙'},{t:'ねこ',p:'🐱'},{t:'へや',p:'🚪'},{t:'ふろ',p:'🛁'},
    {t:'いす',p:'🪑'},{t:'はこ',p:'📦'},{t:'くち',p:'👄'},{t:'かお',p:'😀'},{t:'もも',p:'🍑'},{t:'なし',p:'🍐'},
    {t:'もり',p:'🌲'},{t:'すな',p:'🏖️'},{t:'おに',p:'👹'},{t:'まめ',p:'🫘'},{t:'ゆき',p:'⛄'},{t:'ほね',p:'🦴'},
    {t:'あり',p:'🐜'},{t:'いか',p:'🦑'},{t:'とら',p:'🐯'}
  ]},
  { name: '3もじ ①', hp: 7, items: [
    {t:'きりん',p:'🦒'},{t:'すいか',p:'🍉'},{t:'くるま',p:'🚗'},{t:'ことり',p:'🐦'},{t:'たぬき',p:'🦝'},
    {t:'せかい',p:'🌍'},{t:'ほたる',p:'🪲'},
    {t:'きつね',p:'🦊'},{t:'たいこ',p:'🥁'},{t:'とけい',p:'🕐'},{t:'さかな',p:'🐟'},{t:'みかん',p:'🍊'},
    {t:'かもめ',p:'🐦'},{t:'からす',p:'🐦‍⬛'},{t:'うちわ',p:'🪭'},{t:'すもう',p:'🤼'},{t:'おかし',p:'🍬'},
    {t:'あひる',p:'🦆'},{t:'いるか',p:'🐬'},{t:'かえる',p:'🐸'},{t:'ふくろ',p:'👜'},{t:'まくら',p:'🛏️'}
  ]},
  { name: '3もじ ②', hp: 6, items: [
    {t:'けむり',p:'💨'},{t:'ひよこ',p:'🐤'},{t:'おもち',p:'🍡'},
    {t:'きのこ',p:'🍄'},{t:'やさい',p:'🥬'},{t:'みなと',p:'⚓'},
    {t:'くすり',p:'💊'},{t:'はさみ',p:'✂️'},{t:'えほん',p:'📖'},{t:'たいや',p:'🛞'},{t:'りぼん',p:'🎀'},
    {t:'おはな',p:'🌷'},{t:'ひかり',p:'✨'},{t:'ひるね',p:'😴'},{t:'あさひ',p:'🌅'},{t:'にもつ',p:'🧳'},
    {t:'まつり',p:'🎏'},{t:'たから',p:'💎'},{t:'さいふ',p:'👛'},{t:'やかん',p:'🫖'}
  ]},
  { name: 'てんてん（濁点）', hp: 6, items: [
    {t:'りんご',p:'🍎'},{t:'ぶどう',p:'🍇'},{t:'ばなな',p:'🍌'},{t:'だんご',p:'🍡'},{t:'でんわ',p:'☎️'},
    {t:'かばん',p:'🎒'},{t:'たまご',p:'🥚'},{t:'めがね',p:'👓'},{t:'ごりら',p:'🦍'},
    {t:'でんき',p:'💡'},{t:'かぎ',p:'🔑'},{t:'まど',p:'🪟'},{t:'ひげ',p:'🧔'},{t:'かぜ',p:'🌬️'},{t:'みず',p:'💧'},
    {t:'ひざ',p:'🦵'},{t:'ぞう',p:'🐘'},{t:'ぶた',p:'🐷'},{t:'だるま',p:'🎎'},{t:'ばけつ',p:'🪣'},{t:'ねぎ',p:'🧅'},
    {t:'かがみ',p:'🪞'},{t:'ごはん',p:'🍚'},{t:'いちご',p:'🍓'},{t:'ばら',p:'🌹'},{t:'べんとう',p:'🍱'},{t:'どんぐり',p:'🌰'}
  ]},
  { name: 'まる（半濁点）', hp: 6, items: [
    {t:'ぱんだ',p:'🐼'},{t:'ぴあの',p:'🎹'},{t:'ぷりん',p:'🍮'},{t:'ぱんや',p:'🥐'},{t:'ぴんく',p:'🩷'},
    {t:'ぺん',p:'🖊️'},{t:'たんぽぽ',p:'🌼'},{t:'えんぴつ',p:'✏️'},{t:'てんぷら',p:'🍤'},
    {t:'ぴざ',p:'🍕'},{t:'ぱぱ',p:'👨'},{t:'ぷれぜんと',p:'🎁'},{t:'ぽてと',p:'🍟'},{t:'ぴんぽん',p:'🛎️'},
    {t:'ぽすと',p:'📮'},{t:'ぱんつ',p:'🩲'},{t:'かんぱい',p:'🥂'},{t:'ぴえろ',p:'🤡'},{t:'ぺんぎん',p:'🐧'},
    {t:'ぱそこん',p:'💻'},{t:'さんぽ',p:'🚶'},{t:'ぱんち',p:'👊'}
  ]},
  { name: 'ちいさい っ', hp: 6, items: [
    {t:'きって',p:'📮'},{t:'かっぱ',p:'🥒'},{t:'しっぽ',p:'🐕'},{t:'こっぷ',p:'🥤'},
    {t:'らっぱ',p:'🎺'},{t:'きっぷ',p:'🎫'},{t:'ばった',p:'🦗'},
    {t:'ねっこ',p:'🌱'},{t:'にっき',p:'📔'},{t:'せっけん',p:'🧼'},{t:'まっち',p:'🔥'},{t:'ばっと',p:'🏏'},
    {t:'ろけっと',p:'🚀'},{t:'ぽけっと',p:'👖'},{t:'べっど',p:'🛏️'},{t:'がっき',p:'🎸'},{t:'にっぽん',p:'🗾'},
    {t:'ほっぺ',p:'😊'},{t:'けっこん',p:'💒'},{t:'だっこ',p:'🤱'},{t:'こっき',p:'🚩'},{t:'すっぱい',p:'🍋'}
  ]},
  { name: 'のばすおと ー', hp: 6, items: [
    {t:'けーき',p:'🍰'},{t:'かれー',p:'🍛'},{t:'すきー',p:'🎿'},{t:'ぼーる',p:'⚽'},{t:'ぷーる',p:'🏊'},
    {t:'ごーる',p:'🥅'},{t:'らーめん',p:'🍜'},{t:'こーひー',p:'☕'},{t:'せーたー',p:'🧥'},
    {t:'すぷーん',p:'🥄'},{t:'すーぷ',p:'🍲'},{t:'ぴーまん',p:'🫑'},{t:'ちーず',p:'🧀'},{t:'かーてん',p:'🪟'},
    {t:'すかーと',p:'👗'},{t:'のーと',p:'📓'},{t:'ぼーと',p:'🚣'},{t:'でぱーと',p:'🏬'},{t:'たくしー',p:'🚕'},
    {t:'すけーと',p:'⛸️'},{t:'ぎたー',p:'🎸'},{t:'かーど',p:'🃏'},{t:'すーぱー',p:'🏪'},{t:'こーん',p:'🌽'},
    {t:'どーなつ',p:'🍩'},{t:'はんばーがー',p:'🍔'},{t:'すとろー',p:'🥤'}
  ]},
  { name: 'ちいさい ゃゅょ（拗音）', hp: 6, items: [
    {t:'おちゃ',p:'🍵'},{t:'ちょう',p:'🦋'},{t:'りゅう',p:'🐉'},{t:'きしゃ',p:'🚂'},
    {t:'ちゃわん',p:'🍵'},{t:'おもちゃ',p:'🧸'},{t:'にんじゃ',p:'🥷'},{t:'きんぎょ',p:'🐠'},
    {t:'でんしゃ',p:'🚃'},{t:'かぼちゃ',p:'🎃'},
    {t:'きゅうり',p:'🥒'},{t:'ぎゅうにゅう',p:'🥛'},{t:'しゃしん',p:'📷'},{t:'きょうりゅう',p:'🦕'},
    {t:'じてんしゃ',p:'🚲'},{t:'しょうぼうしゃ',p:'🚒'},{t:'きゅうきゅうしゃ',p:'🚑'},{t:'ちゅうしゃ',p:'💉'},
    {t:'ぎょうざ',p:'🥟'},{t:'りょうり',p:'🍳'},{t:'びょういん',p:'🏥'},{t:'ちょうちょ',p:'🦋'},
    {t:'ひゃく',p:'💯'},{t:'りょこう',p:'✈️'},{t:'しゅくだい',p:'📚'},{t:'ちゃいろ',p:'🟤'},
    {t:'じゃがいも',p:'🥔'},{t:'きゃべつ',p:'🥬'},{t:'ちきゅう',p:'🌏'},{t:'ちょこ',p:'🍫'}
  ]}
];
